...
ggplot(all_melt, aes(x = date, y = I(value/(value + total.job)))) + 
  geom_point(aes(color = int), alpha = 0.5) +
...
**Figure 3.** *Job postings as a proportion of all postings on ECOLOG.*
