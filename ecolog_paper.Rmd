...
Despite an increased emphasis on interdisciplinary training at the graduate and postdoctoral levels (refs), employers in STEM fields still often prefer to hire scientists who are established within a specific disciplinary silo (Nelson 2011). Cluster hiring is a growing trend in academic faculty searches (we did not record data on whether a TT ad was part of a cluster hire), often with the express goal of hiring diverse, interdisciplinary researchers (Flaherty 2015; Urban Universities for Health 2015). However, cluster hires are still a relatively new hiring practice (?) and interdisciplinary early career research candidates were found to frequently be influenced by doubts of department faculty and administrators, or the ability of the department to provide adequate start-up funds and additional hires (Flaherty 2015). Conversely, outside of academia, there is perhaps an increasing demand for researchers who have interdisciplinary training (Nugent & Kulkarni 2013). This doesn't mean that interdisciplinary trainees necessarily are less likely to ultimately be hired into academic positions, but it does mean that often, special care must be taken to ensure that the job candidate's CV reflects deep knowledge/establishment within a discipline (). Even once a tenure-track hire is made, an interdisciplinary researcher may need to manage their promotion process differently than a researcher who is disciplinarily focused (e.g. more depands on time, service to multiple departments, etc.; Pollack & Snir YR?). 
  ...
  * Biotech industry (non-ac) increasingly wants to hire interdisciplinary trained scis instead of specialists. (http://www.nature.com/nbt/journal/v31/n9/full/nbt.2694.html; Nugent & Kulkarni 2013)
  * Cluster hiring is a growing trend in faculty searches to try to encourage diverse, interdisciplinary job candidates (https://www.insidehighered.com/news/2015/05/01/new-report-says-cluster-hiring-can-lead-increased-faculty-diversity; Flaherty 2015). - Piloted at UW-Madison, 149 cluster hire lines generated since 1998. (more details here: http://urbanuniversitiesforhealth.org/media/documents/Faculty_Cluster_Hiring_Report.pdf; Urban Universities for Health) - cluster hires generally had the added benefit of increasing faculty diversity too! - but cluster hires were often plagued by doubts by fellow faculty and administrators, attracting less senior people (pro or con?), maintaining adequate funding for hires/start-ups.
  * managing the tenure-track/promotion process of interdisciplinary faculty (http://cra.org/resources/best-practice-memos/promotion-and-tenure-of-interdisciplinary-faculty/; Pollack & Snir YEAR?)
