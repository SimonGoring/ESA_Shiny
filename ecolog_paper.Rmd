...
Job postings on Ecolog have increased along with the increase in posting volume since 2000, however the increase in total postings as a proportion of job postings for graduate positions is much stronger than for any other job position (**Figure X**).
...
ggplot(all_melt, aes(x = date, y = I(value/(fail_msg+value)), color = class)) + 
